...
export class CritBitTree 
{
  ...
  { name: "inner_nodes", typeTag: new VectorTag(new StructTag(new HexString("0x51d8534aba004732df9a7229f89d6d7a687ad56f8c906e482f62ee298ec7c778"), "critbit", "InnerNode", [])) },
  { name: "outer_nodes", typeTag: new VectorTag(new StructTag(new HexString("0x51d8534aba004732df9a7229f89d6d7a687ad56f8c906e482f62ee298ec7c778"), "critbit", "OuterNode", [new $.TypeParamIdx(0)])) }];
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x51d8534aba004732df9a7229f89d6d7a687ad56f8c906e482f62ee298ec7c778::critbit::CritBitTree", CritBitTree.CritBitTreeParser);
  repo.addParser("0x51d8534aba004732df9a7229f89d6d7a687ad56f8c906e482f62ee298ec7c778::critbit::InnerNode", InnerNode.InnerNodeParser);
  repo.addParser("0x51d8534aba004732df9a7229f89d6d7a687ad56f8c906e482f62ee298ec7c778::critbit::OuterNode", OuterNode.OuterNodeParser);
}
export class App {
  constructor(
